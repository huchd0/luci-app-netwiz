...
# ==========================================
# 【核心优势】
# 1. 极致轻量：使用 Linux 自带的 Python 3，无需安装 Node.js、Docker 或 Nginx 等庞大环境。
# 2. 原生守护：采用 systemd 进程守护，开机自启、崩溃秒级自愈。
#
# 【环境要求】
# VPS 必须具备 IPv6 网络出口能力（原生 IPv6 或通过 Cloudflare WARP 打通的隧道）。
#
# 【详细部署步骤】
# 1. 保存文件：
